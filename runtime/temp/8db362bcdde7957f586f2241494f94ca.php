<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:101:"/home/wwwroot/dt.julongjinrong.top/public/../application/ding/view/collect_case/arbitration_case.html";i:1520995435;}*/ ?>
...
<div class="weui-cells weui-cells_form">
    <div class="weui-cell">
        ...
        <div class="weui-cell__bd">
            <input class="weui-input" type="text" placeholder="请填写" id="crime">
        </div>
    </div>
    <div class="weui-cell">
        <div class="weui-cell__hd">
    ...
    <div class="weui-cell">
        <div class="weui-cell__hd">
            <label class="weui-label">对方当事人姓名/名称</label>
        </div>
        <div class="weui-cell__bd">
            <input class="weui-input" type="text" id="opposite" placeholder="请填写">
        </div>
    </div>
    <div class="weui-cell">
        <div class="weui-cell__hd">
            <label class="weui-label">案由</label>
        </div>
        <div class="weui-cell__bd">
            <input class="weui-input" type="text" placeholder="请填写" id="reason">
        </div>
    </div>
    <div class="weui-cell">
        <div class="weui-cell__hd">
            <label class="weui-label">合同期限</label>
        </div>
        <div class="weui-cell__bd">
            <input class="weui-input" type="text" id="case-status" placeholder="请选择">
        </div>
    </div>
    <div class="weui-cell">
        <div class="weui-cell__hd">
    ...
    <div class="weui-cell">
        ...
        <div class="weui-cell__bd">
            <input class="weui-input" type="file" id="case_file" placeholder="请选择">
        </div>
    </div>
    <div class="margin-gray"></div>
    <div id="margin-gray"></div>
...
<script src="/ding/js/zc_select.js"></script>
<script>
    $(function(){
        ...
        $('#submit').click(function(){
            ...
            var case_stutas = $('#case-status').attr('data-values');
