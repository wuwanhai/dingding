<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:104:"/home/wwwroot/dt.julongjinrong.top/public/../application/ding/view/collect_case/administrative_case.html";i:1520321496;}*/ ?>
...
<div class="weui-cells weui-cells_form">
    ...
    <div class="weui-cell">
        <div class="weui-cell__hd">
            <label class="weui-label">委托人身份</label>
        </div>
        <div class="weui-cell__bd">
            <input class="weui-input" type="text" id="identity" placeholder="犯罪嫌疑人/被告人">
        </div>
    </div>
    <div class="weui-cell">
        <div class="weui-cell__hd">
    ...
    <div class="weui-cell">
        ...
        <div class="weui-cell__bd">
            <input class="weui-input" type="text" placeholder="请填写" id="opposite">
        </div>
    </div>
    <div class="weui-cell">
        <div class="weui-cell__hd">
...
<script src="/ding/js/xz_select.js"></script>
<script>
    $(function(){
        ...
        $('#submit').click(function(){
            ...
            var identity = $('#identity').attr('data-values');
            // var crime = $('#crime').val();
