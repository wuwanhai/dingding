<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"/home/wwwroot/dt.julongjinrong.top/public/../application/ding/view/notice/index.html";i:1518413714;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="weui-cells">
    <div class="weui-flex text-align-center">
        <div class="weui-flex__item">
            <p class="acc-margin-m">总金额（元）</p>
            <p class="acc-margin-n">123456</p>
        </div>
        <div class="weui-flex__item">
...
<div class="weui-panel__bd">
    <a href="javascript:void(0);" class="weui-media-box weui-media-box_appmsg">
        ...
        <div class="weui-media-box__bd">
            <h4 class="weui-media-box__title">北京葆涵律师事务所提成管理办法</h4>
...
<div class="margin-gray"></div>
<div class="weui-cells">
    <a class="weui-cell weui-cell_access" href="case-spend.html">
        <div class="weui-cell__bd">
            <p>办案支出</p>
        </div>
