<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:103:"/home/wwwroot/dt.julongjinrong.top/public/../application/ding/view/collect_case/legal_counsel_case.html";i:1520321497;}*/ ?>
...
<div class="weui-cells weui-cells_form">
    ...
    <div class="weui-cell">
        ...
        <div class="weui-cell__bd">
            <input class="weui-input" type="date" placeholder="请选择" id="start_time">
        </div>
    </div>
    <div class="weui-cell">
        <div class="weui-cell__hd">
        ...
        <div class="weui-cell__bd">
            <input class="weui-input" type="date" placeholder="" id="end_time">
        </div>
    </div>
